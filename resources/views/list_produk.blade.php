            ...
            <div id="productContainer" class="grid grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                @endauth
                    ...
                    <div class="border-t border-gray-50 pt-4 flex items-center justify-between">
                        ...
                        <span class="bg-gray-100 group-hover:bg-[#1b2838] text-gray-400 group-hover:text-white p-3 rounded-xl transition-all inline-flex items-center justify-center">
